            ...
            <div class="w-100 w-md-50 mx-auto">
                <div class="card white card-top-lightblue">
                    <div class="card-content">
                        <span class="card-title black-text">Admin Signup</span>
                        <form method="POST" action="" name="login">
                            <div class="row">
                                ...
                                <div class="center">
                                    <button name="loginStudBtn" class="btn btn-exc z-depth-0 waves-effect mb-n4" id="loginStudBtn" value="Login">Signup</button>
                                </div>
                            </div>
                        </form>
                    </div>
